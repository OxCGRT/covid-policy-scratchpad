...
presented in a CSV format in [/data/output/riskindex_timeseries_latest.csv](./data/output/riskindex_timeseries_latest.csv). The data and it's associated plots will be updated on a daily basis.  
